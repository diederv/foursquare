...
import com.adyen.android.ScrollChildSwipeRefreshLayout;
...
public class SwipeRefreshLayoutDataBinding {
    ...
    public static void setSwipeRefreshLayoutOnRefreshListener(
            ...
            final SwipeRefreshLayout.OnRefreshListener swipeRefreshListener) {
        if (swipeRefreshListener != null) {
            view.setOnRefreshListener(swipeRefreshListener);
        }
    }
